...
spec = {
    "Object": {
        "columns": {
            ...
            columns.UniformGenerator(min_val=0.05, max_val=0.5, n_columns=6, column_val=6),
            "psLnL,psChi2,psN": columns.UniformGenerator(n_columns=6, column_val=7),
            ...
            columns.UniformGenerator(n_columns=114, column_val=8),
            "ugStd,ugStdErr,grStd,grStdErr,riStd,riStdErr,izStd,izStdErr,zyStd,zyStdErr":
            columns.UniformGenerator(min_val=-2, max_val=2, n_columns=10, column_val=9),
            ...
            columns.UniformGenerator(n_columns=24, column_val=10),
            ...
            columns.UniformGenerator(min_val=-1, max_val=1, n_columns=30, column_val=11),
            "uMSum,uMSumErr,gMSum,gMSumErr,rMSum,rMSumErr,iMSum,iMSumErr,zMSum,zMSumErr,yMSum,yMSumErr,uM4,gM4,rM4,iM4,zM4,yM4":
            columns.UniformGenerator(min_val=-1, max_val=1, n_columns=18, column_val=12),
            ...
            columns.UniformGenerator(max_val=10, n_columns=49, column_val=13),
            ...
            columns.UniformGenerator(max_val=10, n_columns=49, column_val=14),
